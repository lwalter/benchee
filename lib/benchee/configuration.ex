defmodule Benchee.Configuration do
  ...
  defstruct [
    ...
    formatter_options: %{
      console: %{
        comparison:       true,
        extended_options: [:minimum, :maximum, :sample_size] # TODO(lnw) I feel that this could be something more dynamic like a list of atoms that correspond to various extended statistics to display
      }
    },
    unit_scaling:         :best,
      ...
      %Benchee.Suite{
        configuration:
          %Benchee.Configuration{
            ...
            formatter_options: %{
              console: %{comparison: true, display_extended: true}
            },
            unit_scaling: :best,
            assigns: %{},
            before_each: nil,
      ...
      %Benchee.Suite{
        configuration:
          %Benchee.Configuration{
            ...
            formatter_options: %{
              console: %{comparison: false, display_extended: true},
              some: "option"
            },
            unit_scaling: :smallest,
            assigns: %{},
